...
//The message was stored in a regular variable so React could not track changes.
//I fixed by moving message into useState and called the setter function setMessage() to update it.
